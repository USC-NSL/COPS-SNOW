...
for trial in $(seq $num_trials); do
    ...
    #for threads_per_client in 1 2 4 8 16 32; do
    #for threads_per_client in 32; do
    #for total_keys in 1000000 100000 10000 1000 100; do
    #for keys_per_read in 5 10 20 40 60 80; do
    #for keys_per_read in 120 160 200 320; do
    #for keys_per_read in 360 400 480 640; do
    for keys_per_read in 10; do
	#total_keys=10000
	total_keys=1000000
	...
	cops_populate_cluster ${total_keys} ${cols_per_key_read} ${value_size} ${cols_per_key_write}
        ...
        cops_run_experiment $total_keys $value_size $cols_per_key_read $cols_per_key_write $keys_per_read $keys_per_write $write_frac $write_trans_frac $run_time $variable $trial $threads_per_client $zipfian $zipfian_constant
...
echo "$exp_uid" >> ~/ro6-nsdi16/experiments/exp_uid_list
#######################################
#
# Cleanup Experiment
#
