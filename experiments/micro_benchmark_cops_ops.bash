...
#HL: Run this script at COPS2's root dir, not inside experiments dir
#Use ./experiments/micro_benchmark_cops_ops.bash
...
cops_dir=$(pwd)
#HL: use my own local machine name
if [ "$machine_name" == "Haonans-MacBook-Air.local" ]; then
    # Local MBP
...
elif [ "$machine_name" == "6Z5SGS1" ]; then
    # Running on nsl cluster's servers 6Z5SGS1 and 1KNTCF1

    dcl_config=2_in_nsl_cluster
    server=1KNTCF1
